...
<div class="row g-4">
    ...
    <div class="col-lg-8">
        <div class="glass-panel p-4 mb-4">
            ...
            <p class="text-secondary small">Placed by {{ $order->user->name }} ({{ $order->user->email }}) on {{ $order->created_at->format('M d, Y h:i A') }}</p>
        ...
        <div class="glass-panel p-4">
            <h4 class="brand-font mb-4">Delivery & Contact</h4>
            <div class="row">
        ...
        <div class="glass-panel p-4">
            ...
            <form action="{{ route('admin.orders.update', $order->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="tracking_number" id="tracking_number" class="form-control form-control-custom" value="{{ $order->tracking_number }}" placeholder="e.g. USPS-94001000000000000">
                    <span class="text-secondary small">Set when order is marked as Shipped.</span>
                </div>
